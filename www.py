...
def all_in_1( market_name, url, price_tag, price_class_attr, unit_tag, unit_class_attr,son_tag='0', sale_tag='0', sale_class_attr='0' ): 
    ...
    if web.status_code==200:   
        ...
        market_list=[market_name , goods_title, goods_price , unit_num , round(goods_price/unit_num,2),sales10]        
        return market_list

def update_sql(market_name,goods_title, goods_price, unit_num,sales10,url):
    #連接sql
    db = pymysql.connect(host=dbs.host,
                    user=dbs.user,
                    password=dbs.password,
    ...
    inserting_sql = """
                ...
                (market_name,goods_title,goods_price,goods_num,unit_price,sale_activity,goods_url)
                VALUES ('{}','{}',{},{},{},'{}','{}')
                ON DUPLICATE KEY UPDATE
                goods_title='{}',goods_price={},goods_num={},unit_price={},sale_activity='{}',timestamp='{}'
                """.format(
                market_name , goods_title,goods_price , unit_num , round(goods_price/unit_num,2),sales10,url,
                goods_title,goods_price , unit_num , round(goods_price/unit_num,2),sales10,datetime.now())        
    try:
